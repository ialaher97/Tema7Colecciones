...
public class Comprobar {
	...
	public static void main(String[] args) {
		...
		Hospital h2 = new Hospital("H1", "ID002",new ArrayList <Object>() );
		Hospital h3 = new Hospital("H1", "ID003",new ArrayList <Object>() );
		Hospital h4 = new Hospital("H1", "ID004",new ArrayList <Object>() );
		Hospital h5 = new Hospital("H1", "ID005",new ArrayList <Object>() );
        ...
        Visita v1 = new Visita("Juan", "Pérez", "Calle A",123456789,"123");
		...
		h2.modificarDireccionCuras("A1", "123", "CALLE Z");
		
		r1.cambiarPersonal("A1", "ID001", "ID002", "Enfermero");
